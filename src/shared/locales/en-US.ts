export const EN_US_MESSAGES = {
    ...
    "settings.mcp_endpoint_desc": "Streamable HTTP with OAuth 2.1, PKCE, protected-resource discovery, dynamic client registration, and refresh tokens. No static API key is needed.",
    ...
    "settings.mcp_transport": "OAuth 2.1 · HTTP",
